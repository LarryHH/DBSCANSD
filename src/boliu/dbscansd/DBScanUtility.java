...
public class DBScanUtility {
	...
	/**
	 * calculate the distance between two points based on their longitude and
	 * latitude
	 * 
	 * @param p1 point 1
	 * @param p2 point 2
	 ...
	 */
	public static boolean isDensityReachable(TrajectoryPoint p1, TrajectoryPoint p2, double eps, int minPts,
			double maxSpd, double maxDir, boolean isStopPoint) {
