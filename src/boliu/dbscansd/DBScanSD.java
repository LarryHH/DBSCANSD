...
public class DBScanSD {
	...
	public ArrayList<TrajectoryPoint> isCorePoint(ArrayList<TrajectoryPoint> lst, TrajectoryPoint p, double eps,
			int minPoints, double speed, double direction, boolean isStopPoint) {
